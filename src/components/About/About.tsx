...
export default function About() {
  return (
    <section className={css.aboutSection}>
      <h2 className={defCss.sectionTitle}>About Us</h2>
      <div className={css.shell}>
        <div className={css.content}>
          <p className={css.abParagraph}>
            I&apos;m a paragraph. Click here to add your own text and edit me.
            It&apos;s easy. Just click &ldquo;Edit Text&rdquo; or double click
            me to add your own content and make changes to the font. Feel free
          ...
          <p className={css.abParagraph}>
            ...
            to drag and drop me anywhere you like on your page. I&apos;m a great
            place for you to tell a story and let your users know a little more
            about you. This is a great space to write long
          </p>
        </div>
